...
def test_equivalent_feature_perturbations():
    ...
    modified_features = equivalent_feature_perturbation(target_node, adj, modified_adj, features)
    ...
    gcn = GCN(nfeat=features.shape[1],
              ...
              dropout=0, with_relu=False, with_bias=False, weight_decay=0, device=device)

    print('=== testing GCN on original(clean) graph ===')
    test(gcn, adj, features, target_node)
    print('=== testing GCN on structure perturbed graph ===')
    test(gcn, modified_adj, features, target_node)
    print('=== testing GCN on feature perturbed graph ===')
    test(gcn, adj, modified_features, target_node)
